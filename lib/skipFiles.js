...
export const checkForInvalidDontDelete = () => {
    const envValue = process.env.PLUGIN_DONT_DELETE_TARGET_FILES;
    return validatePatterns('PLUGIN_DONT_DELETE_TARGET_FILES', envValue);
};
...
export const checkForInvalidDontOverride = () => {
    const envValue = process.env.PLUGIN_DONT_OVERRIDE_TARGET_FILES;
    return validatePatterns('PLUGIN_DONT_OVERRIDE_TARGET_FILES', envValue);
};
...
export const checkForSkipFileReplace = (localRelativePath) => {
    return matchesAnyPattern(localRelativePath, process.env.PLUGIN_DONT_OVERRIDE_TARGET_FILES);
};
...
export const checkForSkipFileDelete = (localRelativePath) => {
    return matchesAnyPattern(localRelativePath, process.env.PLUGIN_DONT_DELETE_TARGET_FILES);
};
